...
class LoadTaskByDateUseCase @Inject constructor(private val repository: ITaskRepository) {
    operator fun invoke(date: String): Flow<ArrayList<TaskEntity>> {
        return repository.loadTasksByDate(date)
    }
}